        ...
        if (
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    var options = {
                        key: nurture.settings.API_KEY,// Enter the Key ID generated from the Dashboard
                        // amount: 10000,
                            ...
                            $.ajax({
                                ...
                                success: function (responsec) {
                                    ...
                                    swal("Congratulations!", responsec.status, "success").then(
                                        (value)=> {
                                            window.location.href ="/products/order-complete/" + responsec.ordernumber + "/" ;
